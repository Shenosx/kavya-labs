...
import { AUTH_ROUTES, type NavbarSession } from "@/lib/auth-routes";
...
export function NavbarClient({ session }: NavbarClientProps) {
  ...
  const authHref = isAuthenticated ? AUTH_ROUTES.dashboard : AUTH_ROUTES.signIn;
  const authLabel = isAuthenticated ? "Open Workspace" : "Get Started";
